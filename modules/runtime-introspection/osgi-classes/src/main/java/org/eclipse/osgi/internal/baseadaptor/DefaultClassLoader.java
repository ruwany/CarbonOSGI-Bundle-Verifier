...
public class DefaultClassLoader extends ClassLoader implements ParallelClassLoader {
    ...
    private String wso2ClassIntrospectionClassName = System.getProperty("wso2.osgi.class.loader.intro.name");
    ...
    protected Class<?> loadClass(String name, boolean resolve) throws ClassNotFoundException {
        ...
        try {
            ...
            if(wso2ClassIntrospectionClassName != null && wso2ClassIntrospectionClassName.equals(name)) {
                LoadingIntrospection.push(name);
            }
